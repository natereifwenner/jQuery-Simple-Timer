System.register("simple.timer.es6", [], function() {
  "use strict";
  var __moduleName = "simple.timer.es6";
  (function($) {
    $.fn.startTimer = function(options) {
      ...
      var createSubDivs = function(timerBoxElement) {
        ...
        return timerBoxElement.append(hours).append(minutes).append(seconds).append(clearDiv);
      };
